...
/**
  ...
  * });
  */
const StreamDownloader = (url: string | ytdl.videoInfo, options: YTDLStreamOptions) => {
    if (!url) {
    ...
    const inputStream = typeof url === "string" ? ytdl(url, options) : ytdl.downloadFromInfo(url, options);
